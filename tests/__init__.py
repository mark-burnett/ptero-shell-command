...
STARTUP_WAIT = int(os.environ.get('PTERO_SHELL_COMMAND_TEST_STARTUP_WAIT', 5))
SERVICE_COMMAND = [
    './devserver', '--num-http-workers', '1', '--num-fork-workers', '1',
    '--logdir', 'var/log']
...
def setUp():
    ...
    if not os.environ.get('PTERO_SHELL_COMMAND_TEST_SKIP_PROCFILE'):
